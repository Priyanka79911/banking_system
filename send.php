...
<a href="index.php" class="btn btn-primary m-2">Home</a><a href="add.php" class="btn btn-success m-2">Add Customer</a><a href="view.php" class="btn btn-danger m-2">View All Customer</a><a href="send.php" class="btn btn-warning m-2">Send Money</a>
    </div>
<div class="col-md-6 m-auto register-form-border reg-forms">

  <h2 class="text-center text-light">Send Money</h2>
  ...
  <form method="POST">
   ...
   <div class="text-center">
    <button type="submit" class="btn btn-primary" name="send">Send Money</button>
   </div>
  </form>
</div>
