...
<div class="container mt-4">
         ...
         <a href="index.php" class="btn btn-primary m-2">Home</a><a href="add.php" class="btn btn-success m-2">Add Customer</a><a href="index.php" class="btn btn-danger m-2">View All Customer</a><a href="send.php" class="btn btn-warning m-2">Send Money</a>
    </div>
